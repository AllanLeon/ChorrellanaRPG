...
/*
	...
	else if(this.stage == 'forestStage'){
		this.forestblocks();
	}
	else if(this.stage == 'forestRun'){
		this.forestrunblocks();
	}
...
Obstacle.prototype.forestblocks = function(){
	...
	this.bloque = this.blocks.create(25,210, 'blockH');
	this.bloque.body.immovable = true;
	this.bloque.width = 15;
	this.bloque.height = 200;
