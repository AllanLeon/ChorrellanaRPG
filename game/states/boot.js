...
States.Boot = {
	...
	preload: function(){
		...
		this.game.load.image('kirby', 'assets/images/characters/kirby.png');
		this.game.load.image('yoshi', 'assets/images/characters/yoshi.png');
		...
		this.game.load.spritesheet('pikachu', 'assets/images/enemys/pikaattack.png',192, 50);
		this.game.load.image('blockf', 'assets/images/enemys/forestcollider.png');
		...
		this.game.load.image('forestmap', 'assets/images/backgrounds/miniforestgump.png');
		...
		this.game.load.image('bubble','assets/images/effects/bubble.png');
		...
		this.game.load.image('apple','assets/images/inventory/apple.png');
